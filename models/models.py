...
class CustomLLM(LLM):
    ...
    def load_model(self, base_models: str) -> None:
        ...
        if self.model_name == "Human":
            ...
            or self.model_name == "OpenBioLLM-70B"
            or self.model_name == "Llama-3.1-70B-Instruct"
        ):
            ...
            bb_cfg = BitsAndBytesConfig(
                load_4bit=True, bnb_4bit_compute_dtype=torch.bfloat16
            )
            self.model = AutoModelForCausalLM.from_pretrained(
                base_model,
                cache_dir=base_models,
