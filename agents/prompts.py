...
{diagnostic_criteria}{input}{user_tag_end}{ai_tag_start}Final Diagnosis:"""
...
DIAGNOSTIC_CRITERIA_FULL = """Based on the provided diagnostic criteria, please analyze and diagnose the disease. The diagnostic criteria are offered as a reference; however, it is essential to consider the actual condition of the patient comprehensively. Please provide a diagnosis that aligns with the given information and the patient's specific situation.
...
Pericardial rub heard during physical examination
ST segment elevation or changes on ECG
Evidence of pericardial effusion on imaging studies (echocardiogram, CT, or radiography)
Positional chest pain improving when sitting up and leaning forward (spoon sign)
Pericardial friction rub on physical examination
Pericarditis rare:
Biphasic friction rub on physical examination
High ESR with marked leukocyrosis (e.g., Neutrophils ≥75%)
Constrictive cardiomypathy with diffused pericardial thickenig and calcfication
Systemic symptoms like low-grade fever and night sweats
Radiographic evidence of water-bottle-shaped heart
Leukocytosis with high neutrophil percentage
Mediastinal lymphadenopathy on imaging in tuberculous pericarditis
...
Clinical improvement after appropriate antibiotic therapy, helping to confirm bacterial or atypical infection
Pneumonia rare:
...
Identification of emerging or atypical pathogens (e.g., SARS-CoV-2, Legionella, avian influenza)
Signs of systemic infection: hypotension, tachycardia, or septic shock when pneumonia is severe
